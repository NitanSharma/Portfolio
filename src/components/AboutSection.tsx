    ...
    <section className=" container min-h-screen w-full mt-20 ">
      ...
      <div className="flex flex-col lg:flex-row items-start justify-center p-4">
        <div className="left w-full lg:w-1/2 text-white gap-4 px-4 py-8 flex flex-col">
          <p>
            Hey! I&apos;m Nitin, a full stack developer who loves building
            interactive websites using modern tools like React, Next.js, Express and
            Tailwind.
          </p>
          <p>
            I&apos;m currently focused on improving my skills and working on
            personal projects.
          </p>
          <p>
