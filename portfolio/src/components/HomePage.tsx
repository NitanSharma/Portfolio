  ...
  return (
    ...
    >
      ...
      <h1 className="font-bold text-4xl md:text-6xl lg:text-8xl">
        Hey, I&apos;m Nitin<span className="text-[#0AFF9D]">.</span>
      </h1>
      <h6 className="mt-5 text-2xl md:text-4xl lg:text-5xl">
        I&apos;m a{' '}
        <span className="text-[#0AFF9D] font-bold">Full Stack Developer</span>
      </h6>
      <p className="mt-4 w-full md:w-3/4 lg:w-1/2">
        I&apos;m a passionate Full Stack Developer skilled in React, Next.js, Node.js,
